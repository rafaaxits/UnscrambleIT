 ...
 *
 */
class AdvancedLevelsFragment : android.app.Fragment() {
    var mAuth: FirebaseAuth? = null

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        // Inflate the layout for this fragment
        val view =  inflater.inflate(R.layout.fragment_advanced_levels, container, false)
        ...
        btnSecondLevel.setOnClickListener(){
            val intent = Intent(activity, UnscrambleIT_beginner_level1::class.java)
            intent.putExtra("level", "advanced2")
            startActivity(intent)
        }

        btnThirdLevel.setOnClickListener(){
            val intent = Intent(activity, UnscrambleIT_beginner_level1::class.java)
            intent.putExtra("level", "advanced3")
            startActivity(intent)
        }

        btnFourthLevel.setOnClickListener(){
            val intent = Intent(activity, UnscrambleIT_beginner_level1::class.java)
            intent.putExtra("level", "advanced4")
            startActivity(intent)
        }

        btnFifthLevel.setOnClickListener(){
            val intent = Intent(activity, UnscrambleIT_beginner_level1::class.java)
            intent.putExtra("level", "advanced5")
            startActivity(intent)
        }
